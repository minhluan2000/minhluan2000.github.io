  ...
  <nav class="navbar navbar-expand-sm bg-primary text-white navbar-dark">
    <div class="container-fluid justify-content-center" style="margin-top: 60px;">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-light active" href="{{ url('/lien-he') }}">Liên hệ</a>
        </li>
      </ul>
    </div>
  </nav>
                ...
                <div class="row justify-content-around">
                  <form action="" class="col-md-6 p-3 my-3 border bg-light">
                    ...
                    <div class="form-group my-2">
                      ...
                      <span><input type="text" name="fullname" id="fullname" class="form-control" required></span>
                    </div>
                    <div class="form-group my-2">
                    ...
                    <button type="submit" class="btn btn-primary my-2" style="float: right;">Gửi</button>
                  </form>
                </div>
              </div>
