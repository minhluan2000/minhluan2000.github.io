  ...
  <nav class="navbar navbar-expand-sm bg-primary text-white navbar-dark">
    <div class="container-fluid justify-content-center" style="margin-top: 60px;">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-light active" href="{{ url('/tintuc-sukien') }}">Tin tức - Sự kiện</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row">
      ...
      <div class="col-sm-6 my-4">
        ...
        <div class="container-fluid py-3">
          <div class="row py-3">
            <div class="col-3">
              <a href="#!"><img src="/image/Đắc_nhân_tâm.jpg" alt="" style="width: 100%;"></a>
            </div>
            <div class="col">
              <a href="#!">
                <h5>Những cuốn sách hay nhất định phải đọc một lần trong đời</h5>
              </a>
              <p>Đắc nhân tâm của Dale Carnegie là quyển sách của mọi thời đại và một hiện tượng đáng kinh ngạc
                trong ngành xuất bản Hoa Kỳ. Trong suốt nhiều thập kỷ tiếp theo và cho đến tận bây giờ, tác phẩm
                này vẫn chiếm vị trí số một trong danh mục sách bán chạy nhất và trở thành một sự kiện có một
                không hai trong lịch sử ngành xuất bản thế giới và được đánh giá là một quyển sách có tầm ảnh
        ...
        <div class="container-fluid py-3">
          <div class="row py-3">
            ...
            <div class="col">
              ...
              <p>Xin giới thiệu tới quý bạn 18 cuốn sách đặc thù được bạn đọc quan tâm và tìm mua nhiều nhất
        ...
        <div class="container-fluid py-3">
          <div class="row py-3">
            <div class="col-3">
              <a href="#!"><img src="/image/tintuc-hinhanh/ss.png" alt="" style="width: 100%; height: 80%;"></a>
            </div>
            <div class="col">
              <a href="#!">
                <h5>Top 108 sách được bạn đọc quan tâm tìm mua nhiều nhất trên diễn đàn và mạng xã hội</h5>
              </a>
              <p>108 tựa sách hay tiêu biểu, giảm tới 30%. Tất cả đều là sách có bản quyền, bản in đẹp, cung
                cấp trực tiếp từ gần 70 Nhà xuất bản, đơn vị phát hành, trân trọng giới thiệu cùng quý bạn đọc!
              </p>
            </div>
          </div>
        </div>
